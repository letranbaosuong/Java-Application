 ...
 */
package com.mycompany.demotrochoixeposo;
 ...
 * @author Suong
 */
public class DemoGameXepOSo extends javax.swing.JFrame {

    /**
     * Creates new form DemoGameXepOSo
     */
    public DemoGameXepOSo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DemoGameXepOSo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DemoGameXepOSo().setVisible(true);
            }
        });
    }
    ...
    private void winChua() {
        ...
        if (this.so15.getText().equals("1")
                ...
                && this.ktraBtnStart) {
            int ret = JOptionPane.showConfirmDialog(null, this.getTitle() + " có muốn chơi tiếp không?", " Chiến Thắng!", JOptionPane.YES_NO_OPTION);
